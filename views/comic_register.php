...
<head>
    ...
    <style>
        :root {
            ...
            --wcag-aaa-text: #333; /* 7.06:1 */
            --wcag-aaa-primary-text: #004085; /* 7.08:1 on light, use white text on primary bg */
            --wcag-aaa-button-bg: #005cbf; /* 4.54:1, ok for large text/graphics */
            --wcag-aaa-button-text: var(--white-color); /* 5.66:1 on aaa-button-bg */
        ...
        *, *::before, *::after {
        ...
        body {
            ...
            color: var(--text-color); /* WCAG: Use high contrast text */
        ...
        .button {
            ...
            outline: 3px solid transparent; /* For focus */
        }
        .button:hover {
        ...
        .button:focus {
            outline: 3px solid var(--warning-color); /* WCAG: Clear focus indicator */
        ...
        .form-control:focus {
            border-color: var(--primary-hover-color);
            outline: 0;
            box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.25); /* WCAG: Clear focus */
        }
        /* ISBN入力欄コンテナ */
        #isbn-list {
            margin-bottom: 1rem;
        ...
        .comic-preview-item p {
            margin-bottom: 0.3rem; /* Smaller spacing */
        ...
        .status-error {
            color: #721c24; /* WCAG AAA Text on light red */
            background-color: #f8d7da;
            border-color: #f5c6cb;
        }
        .status-success {
            color: #155724; /* WCAG AAA Text on light green */
            background-color: #d4edda;
            border-color: #c3e6cb;
        }

        #bulk-status { margin-top: 1rem; } /* 一括処理用ステータス */
        ...
        @media (max-width: 768px) {
            ...
            .isbn-input-item { flex-direction: column; align-items: stretch; }
            .isbn-input-item input[type="text"] { margin-right: 0; margin-bottom: 0.5rem; }
            .isbn-input-item .button-danger { width: 100%; } /* 削除ボタンを幅一杯に */
            .comic-preview-item {
    ...
    <main>
        <section aria-labelledby="isbn-section-title">
            ...
            <button type="button" id="add-isbn-button" class="button button-secondary">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16" aria-hidden="true" style="vertical-align: -0.125em;">
                  <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2"/>
                </svg>
                入力欄を追加
            </button>
            <button type="button" id="bulk-fetch-button" class="button button-primary" style="margin-left: 1rem;">
                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-download-fill" viewBox="0 0 16 16" aria-hidden="true" style="vertical-align: -0.125em;">
                   <path fill-rule="evenodd" d="M8 0a5.53 5.53 0 0 0-3.594 1.342c-.766.66-1.321 1.52-1.464 2.383C1.266 4.095 0 5.555 0 7.318 0 9.366 1.708 11 3.781 11H7.5V5.5a.5.5 0 0 1 1 0V11h4.188C14.502 11 16 9.57 16 7.773c0-1.636-1.242-2.969-2.834-3.194C12.923 1.999 10.69 0 8 0m-.354 15.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 14.293V11h-1v3.293l-2.146-2.147a.5.5 0 0 0-.708.708z"/>
                 </svg>
                 入力されたISBNの情報を一括取得
            </button>
            <div id="bulk-status" class="status-message" style="display: none;" role="alert" aria-live="assertive"></div>
        </section>
        ...
        <section class="action-buttons" aria-label="登録操作">
            <button type="button" id="save-comics-button" class="button button-success" disabled>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16" aria-hidden="true" style="vertical-align: -0.125em;">
